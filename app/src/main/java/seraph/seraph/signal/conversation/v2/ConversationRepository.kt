...
import seraph.zion.signal.ShortcutLauncherActivity
import seraph.zion.signal.attachments.TombstoneAttachment
import seraph.zion.signal.components.emoji.EmojiStrings
import seraph.zion.signal.components.reminder.BubbleOptOutReminder
import seraph.zion.signal.components.reminder.ExpiredBuildReminder
import seraph.zion.signal.components.reminder.GroupsV1MigrationSuggestionsReminder
import seraph.zion.signal.components.reminder.PendingGroupJoinRequestsReminder
...
import seraph.zion.signal.conversation.v2.RequestReviewState.GroupReviewState
import seraph.zion.signal.conversation.v2.RequestReviewState.IndividualReviewState
import seraph.zion.signal.conversation.v2.data.ConversationDataSource
...
import seraph.zion.signal.jobs.MultiDeviceViewOnceOpenJob
...
import seraph.zion.signal.profiles.spoofing.ReviewUtil
...
import seraph.zion.signal.util.BitmapUtil
import seraph.zion.signal.util.DrawableUtil
import seraph.zion.signal.util.MediaUtil
import seraph.zion.signal.util.MessageUtil
import seraph.zion.signal.util.SignalLocalMetrics
import seraph.zion.signal.util.Util
import seraph.zion.signal.util.hasLinkPreview
import seraph.zion.signal.util.hasSharedContact
import seraph.zion.signal.util.hasTextSlide
import seraph.zion.signal.util.isViewOnceMessage
import seraph.zion.signal.util.requireTextSlide
...
class ConversationRepository(
  ...
  private val oldConversationRepository = seraph.zion.signal.conversation.ConversationRepository()
