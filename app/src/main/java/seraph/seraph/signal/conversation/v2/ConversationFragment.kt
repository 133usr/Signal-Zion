...
import seraph.zion.signal.BlockUnblockDialog
import seraph.zion.signal.GroupMembersDialog
import seraph.zion.signal.LoggingFragment
import seraph.zion.signal.MainActivity
import seraph.zion.signal.MuteDialog
import seraph.zion.signal.R
import seraph.zion.signal.audio.AudioRecorder
import seraph.zion.signal.badges.gifts.OpenableGift
import seraph.zion.signal.badges.gifts.OpenableGiftItemDecoration
import seraph.zion.signal.badges.gifts.flow.GiftFlowActivity
import seraph.zion.signal.badges.gifts.viewgift.received.ViewReceivedGiftBottomSheet
import seraph.zion.signal.badges.gifts.viewgift.sent.ViewSentGiftBottomSheet
import seraph.zion.signal.components.AnimatingToggle
import seraph.zion.signal.components.ComposeText
import seraph.zion.signal.components.ConversationSearchBottomBar
import seraph.zion.signal.components.HidingLinearLayout
import seraph.zion.signal.components.InputAwareConstraintLayout
import seraph.zion.signal.components.InputPanel
import seraph.zion.signal.components.InsetAwareConstraintLayout
import seraph.zion.signal.components.ProgressCardDialogFragment
import seraph.zion.signal.components.ProgressCardDialogFragmentArgs
import seraph.zion.signal.components.ScrollToPositionDelegate
import seraph.zion.signal.components.SendButton
...
import seraph.zion.signal.components.location.SignalPlace
import seraph.zion.signal.components.mention.MentionAnnotation
import seraph.zion.signal.components.menu.ActionItem
import seraph.zion.signal.components.menu.SignalBottomActionBar
import seraph.zion.signal.components.settings.app.subscription.donate.DonateToSignalFragment
import seraph.zion.signal.components.settings.app.subscription.donate.DonateToSignalType
import seraph.zion.signal.components.settings.conversation.ConversationSettingsActivity
import seraph.zion.signal.components.spoiler.SpoilerAnnotation
import seraph.zion.signal.components.voice.VoiceNoteDraft
import seraph.zion.signal.components.voice.VoiceNoteMediaControllerOwner
import seraph.zion.signal.components.voice.VoiceNotePlaybackState
import seraph.zion.signal.components.voice.VoiceNotePlayerView
import seraph.zion.signal.contacts.paged.ContactSearchKey.RecipientSearchKey
import seraph.zion.signal.contactshare.Contact
import seraph.zion.signal.contactshare.ContactUtil
import seraph.zion.signal.contactshare.SharedContactDetailsActivity
import seraph.zion.signal.conversation.AttachmentKeyboardButton
import seraph.zion.signal.conversation.BadDecryptLearnMoreDialog
...
import seraph.zion.signal.conversation.ConversationHeaderView
import seraph.zion.signal.conversation.ConversationIntents
import seraph.zion.signal.conversation.ConversationIntents.ConversationScreenType
import seraph.zion.signal.conversation.ConversationItem
import seraph.zion.signal.conversation.ConversationItemSelection
import seraph.zion.signal.conversation.ConversationItemSwipeCallback
import seraph.zion.signal.conversation.ConversationMessage
import seraph.zion.signal.conversation.ConversationOptionsMenu
import seraph.zion.signal.conversation.ConversationReactionDelegate
import seraph.zion.signal.conversation.ConversationReactionOverlay
import seraph.zion.signal.conversation.ConversationReactionOverlay.OnActionSelectedListener
import seraph.zion.signal.conversation.ConversationReactionOverlay.OnHideListener
import seraph.zion.signal.conversation.ConversationSearchViewModel
import seraph.zion.signal.conversation.ConversationUpdateTick
import seraph.zion.signal.conversation.MarkReadHelper
import seraph.zion.signal.conversation.MenuState
import seraph.zion.signal.conversation.MessageSendType
import seraph.zion.signal.conversation.MessageStyler.getStyling
import seraph.zion.signal.conversation.ReenableScheduledMessagesDialogFragment
import seraph.zion.signal.conversation.ScheduleMessageContextMenu
import seraph.zion.signal.conversation.ScheduleMessageDialogCallback
import seraph.zion.signal.conversation.ScheduleMessageTimePickerBottomSheet
import seraph.zion.signal.conversation.ScheduleMessageTimePickerBottomSheet.Companion.showSchedule
import seraph.zion.signal.conversation.ScheduledMessagesBottomSheet
import seraph.zion.signal.conversation.ScheduledMessagesRepository
import seraph.zion.signal.conversation.SelectedConversationModel
import seraph.zion.signal.conversation.ShowAdminsBottomSheetDialog
...
import seraph.zion.signal.conversation.drafts.DraftRepository
import seraph.zion.signal.conversation.drafts.DraftRepository.ShareOrDraftData
import seraph.zion.signal.conversation.drafts.DraftViewModel
import seraph.zion.signal.conversation.mutiselect.ConversationItemAnimator
import seraph.zion.signal.conversation.mutiselect.MultiselectItemDecoration
import seraph.zion.signal.conversation.mutiselect.MultiselectPart
import seraph.zion.signal.conversation.mutiselect.forward.MultiselectForwardBottomSheet
import seraph.zion.signal.conversation.mutiselect.forward.MultiselectForwardFragment
import seraph.zion.signal.conversation.mutiselect.forward.MultiselectForwardFragmentArgs
import seraph.zion.signal.conversation.quotes.MessageQuotesBottomSheet
import seraph.zion.signal.conversation.ui.edit.EditMessageHistoryDialog
import seraph.zion.signal.conversation.ui.error.EnableCallNotificationSettingsDialog
import seraph.zion.signal.conversation.ui.inlinequery.InlineQuery
import seraph.zion.signal.conversation.ui.inlinequery.InlineQueryChangedListener
import seraph.zion.signal.conversation.ui.inlinequery.InlineQueryReplacement
import seraph.zion.signal.conversation.ui.inlinequery.InlineQueryResultsControllerV2
import seraph.zion.signal.conversation.ui.inlinequery.InlineQueryViewModelV2
import seraph.zion.signal.conversation.v2.computed.ConversationMessageComputeWorkers
import seraph.zion.signal.conversation.v2.data.ConversationMessageElement
import seraph.zion.signal.conversation.v2.groups.ConversationGroupCallViewModel
import seraph.zion.signal.conversation.v2.groups.ConversationGroupViewModel
import seraph.zion.signal.conversation.v2.items.ChatColorsDrawable
import seraph.zion.signal.conversation.v2.items.InteractiveConversationElement
import seraph.zion.signal.conversation.v2.keyboard.AttachmentKeyboardFragment
import seraph.zion.signal.database.DraftTable
...
import seraph.zion.signal.database.model.Quote
...
import seraph.zion.signal.databinding.V2ConversationFragmentBinding
import seraph.zion.signal.dependencies.ApplicationDependencies
import seraph.zion.signal.events.GroupCallPeekEvent
import seraph.zion.signal.events.ReminderUpdateEvent
...
import seraph.zion.signal.groups.ui.LeaveGroupDialog
import seraph.zion.signal.groups.ui.invitesandrequests.ManagePendingAndRequestingMembersActivity
import seraph.zion.signal.groups.ui.invitesandrequests.invite.GroupLinkInviteFriendsBottomSheetDialogFragment
import seraph.zion.signal.groups.ui.managegroup.dialogs.GroupDescriptionDialog
import seraph.zion.signal.groups.ui.migration.GroupsV1MigrationInfoBottomSheetDialogFragment
import seraph.zion.signal.groups.ui.migration.GroupsV1MigrationSuggestionsDialog
import seraph.zion.signal.groups.v2.GroupBlockJoinRequestResult
import seraph.zion.signal.invites.InviteActions
import seraph.zion.signal.keyboard.KeyboardPage
import seraph.zion.signal.keyboard.KeyboardPagerFragment
import seraph.zion.signal.keyboard.KeyboardPagerViewModel
import seraph.zion.signal.keyboard.KeyboardUtil
import seraph.zion.signal.keyboard.emoji.EmojiKeyboardPageFragment
import seraph.zion.signal.keyboard.emoji.search.EmojiSearchFragment
import seraph.zion.signal.keyboard.gif.GifKeyboardPageFragment
...
import seraph.zion.signal.linkpreview.LinkPreviewViewModelV2
import seraph.zion.signal.longmessage.LongMessageFragment
import seraph.zion.signal.mediaoverview.MediaOverviewActivity
import seraph.zion.signal.mediapreview.MediaIntentFactory
import seraph.zion.signal.mediapreview.MediaPreviewV2Activity
import seraph.zion.signal.mediasend.Media
import seraph.zion.signal.mediasend.MediaSendActivityResult
import seraph.zion.signal.messagedetails.MessageDetailsFragment
import seraph.zion.signal.messagerequests.MessageRequestRepository
import seraph.zion.signal.messagerequests.MessageRequestState
import seraph.zion.signal.mms.AttachmentManager
import seraph.zion.signal.mms.AudioSlide
import seraph.zion.signal.mms.GifSlide
import seraph.zion.signal.mms.ImageSlide
...
import seraph.zion.signal.mms.SlideFactory
import seraph.zion.signal.mms.StickerSlide
import seraph.zion.signal.mms.VideoSlide
import seraph.zion.signal.notifications.v2.ConversationId
import seraph.zion.signal.payments.preferences.PaymentsActivity
import seraph.zion.signal.permissions.Permissions
import seraph.zion.signal.profiles.spoofing.ReviewCardDialogFragment
import seraph.zion.signal.providers.BlobProvider
import seraph.zion.signal.ratelimit.RecaptchaProofBottomSheetFragment
import seraph.zion.signal.ratelimit.RecaptchaRequiredEvent
import seraph.zion.signal.reactions.ReactionsBottomSheetDialogFragment
import seraph.zion.signal.reactions.any.ReactWithAnyEmojiBottomSheetDialogFragment
import seraph.zion.signal.recipients.Recipient
import seraph.zion.signal.recipients.RecipientExporter
...
import seraph.zion.signal.recipients.ui.disappearingmessages.RecipientDisappearingMessagesActivity
import seraph.zion.signal.registration.RegistrationNavigationActivity
import seraph.zion.signal.revealable.ViewOnceMessageActivity
import seraph.zion.signal.revealable.ViewOnceUtil
import seraph.zion.signal.safety.SafetyNumberBottomSheet
...
import seraph.zion.signal.stickers.StickerPackInstallEvent
import seraph.zion.signal.stickers.StickerPackPreviewActivity
import seraph.zion.signal.stories.StoryViewerArgs
import seraph.zion.signal.stories.viewer.StoryViewerActivity
import seraph.zion.signal.util.BottomSheetUtil
import seraph.zion.signal.util.BubbleUtil
import seraph.zion.signal.util.CommunicationActions
import seraph.zion.signal.util.ContextUtil
import seraph.zion.signal.util.ConversationUtil
import seraph.zion.signal.util.DateUtils
import seraph.zion.signal.util.Debouncer
import seraph.zion.signal.util.DeleteDialog
import seraph.zion.signal.util.Dialogs
import seraph.zion.signal.util.DrawableUtil
import seraph.zion.signal.util.FeatureFlags
import seraph.zion.signal.util.FullscreenHelper
import seraph.zion.signal.util.MediaUtil
import seraph.zion.signal.util.MessageConstraintsUtil
import seraph.zion.signal.util.MessageConstraintsUtil.getEditMessageThresholdHours
import seraph.zion.signal.util.MessageConstraintsUtil.isValidEditMessageSend
import seraph.zion.signal.util.PlayStoreUtil
import seraph.zion.signal.util.SaveAttachmentUtil
import seraph.zion.signal.util.SignalLocalMetrics
...
import seraph.zion.signal.util.concurrent.ListenableFuture
import seraph.zion.signal.util.createActivityViewModel
import seraph.zion.signal.util.doAfterNextLayout
import seraph.zion.signal.util.fragments.requireListener
import seraph.zion.signal.util.getRecordQuoteType
import seraph.zion.signal.util.hasAudio
import seraph.zion.signal.util.hasGiftBadge
import seraph.zion.signal.util.hasNonTextSlide
import seraph.zion.signal.util.isValidReactionTarget
import seraph.zion.signal.util.savedStateViewModel
import seraph.zion.signal.util.viewModel
import seraph.zion.signal.util.views.Stub
import seraph.zion.signal.util.visible
import seraph.zion.signal.verify.VerifyIdentityActivity
import seraph.zion.signal.wallpaper.ChatWallpaper
import seraph.zion.signal.wallpaper.ChatWallpaperDimLevelUtil
