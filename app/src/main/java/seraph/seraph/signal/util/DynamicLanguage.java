...
import seraph.zion.signal.util.dynamiclanguage.LanguageString;

import java.util.Locale;

/**
 * @deprecated Use a base activity that uses the {@link seraph.zion.signal.util.dynamiclanguage.DynamicLanguageContextWrapper}
 */
@Deprecated
