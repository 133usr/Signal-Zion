...
import seraph.zion.signal.jobs.ConversationShortcutUpdateJob;
...
public final class ConversationUtil {
  ...
  private static final String CATEGORY_SHARE_TARGET = "seraph.zion.signal.sharing.CATEGORY_SHARE_TARGET";
