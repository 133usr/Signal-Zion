...
import seraph.zion.signal.lock.RegistrationLockReminders;
import seraph.zion.signal.notifications.NotificationChannels;
import seraph.zion.signal.notifications.NotificationIds;
import seraph.zion.signal.preferences.widgets.NotificationPrivacyPreference;
...
public class TextSecurePreferences {
  ...
  /**
   * @deprecated Use {@link SettingsValues#getMessageFontSize()} via {@link seraph.zion.signal.keyvalue.SignalStore} instead.
   */
  @Deprecated
  ...
  /**
   * @deprecated Use {@link SettingsValues#getTheme()} via {@link seraph.zion.signal.keyvalue.SignalStore} instead.
   */
  @Deprecated
  ...
  /**
   * @deprecated Use {@link SettingsValues#getLanguage()} via {@link seraph.zion.signal.keyvalue.SignalStore} instead.
   */
  @Deprecated
  ...
  /**
   * @deprecated Use {@link SettingsValues#setLanguage(String)} via {@link seraph.zion.signal.keyvalue.SignalStore} instead.
   */
  @Deprecated
