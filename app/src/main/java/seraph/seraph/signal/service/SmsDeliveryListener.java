...
import seraph.zion.signal.jobs.SmsSentJob;
...
public class SmsDeliveryListener extends BroadcastReceiver {
  ...
  public static final String SENT_SMS_ACTION      = "seraph.zion.signal.SendReceiveService.SENT_SMS_ACTION";
  public static final String DELIVERED_SMS_ACTION = "seraph.zion.signal.SendReceiveService.DELIVERED_SMS_ACTION";
