...
class AndroidCallConnectionService : ConnectionService() {
  ...
  companion object {
    ...
    const val KEY_RECIPIENT_ID = "seraph.zion.signal.RECIPIENT_ID"
    const val KEY_CALL_ID = "seraph.zion.signal.CALL_ID"
    const val KEY_VIDEO_CALL = "seraph.zion.signal.VIDEO_CALL"
  }
