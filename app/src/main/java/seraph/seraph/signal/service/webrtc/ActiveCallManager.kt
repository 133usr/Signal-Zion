...
import seraph.zion.signal.jobs.UnableToStartException
import seraph.zion.signal.recipients.Recipient
import seraph.zion.signal.recipients.RecipientId
import seraph.zion.signal.service.SafeForegroundService
import seraph.zion.signal.util.TelephonyUtil
import seraph.zion.signal.webrtc.CallNotificationBuilder
import seraph.zion.signal.webrtc.UncaughtExceptionHandlerManager
import seraph.zion.signal.webrtc.audio.AudioManagerCommand
import seraph.zion.signal.webrtc.audio.SignalAudioManager
import seraph.zion.signal.webrtc.audio.SignalAudioManager.Companion.create
...
class ActiveCallManager(
  ...
  class ActiveCallServiceReceiver : BroadcastReceiver() {
    ...
    companion object {
      const val ACTION_DENY = "seraph.zion.signal.service.webrtc.ActiveCallAction.DENY"
      const val ACTION_HANGUP = "seraph.zion.signal.service.webrtc.ActiveCallAction.HANGUP"
    }
