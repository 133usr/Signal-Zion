...
import seraph.zion.signal.webrtc.audio.OutgoingRinger;

import java.util.HashMap;
import java.util.Map;
import java.util.Objects;

import static seraph.zion.signal.webrtc.CallNotificationBuilder.TYPE_ESTABLISHED;
import static seraph.zion.signal.webrtc.CallNotificationBuilder.TYPE_INCOMING_CONNECTING;
import static seraph.zion.signal.webrtc.CallNotificationBuilder.TYPE_INCOMING_RINGING;
import static seraph.zion.signal.webrtc.CallNotificationBuilder.TYPE_OUTGOING_RINGING;
