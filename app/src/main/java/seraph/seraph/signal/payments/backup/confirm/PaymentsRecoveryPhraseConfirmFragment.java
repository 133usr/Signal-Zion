package seraph.zion.signal.payments.backup.confirm;
...
public class PaymentsRecoveryPhraseConfirmFragment extends Fragment {
  ...
  public static final  String   REQUEST_KEY_RECOVERY_PHRASE = "seraph.zion.signal.payments.backup.confirm.RECOVERY_PHRASE";
