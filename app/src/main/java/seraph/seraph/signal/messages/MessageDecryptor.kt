...
import seraph.zion.signal.jobs.SendRetryReceiptJob
import seraph.zion.signal.keyvalue.SignalStore
import seraph.zion.signal.logsubmit.SubmitDebugLogActivity
import seraph.zion.signal.messages.MessageDecryptor.FollowUpOperation
import seraph.zion.signal.messages.protocol.BufferedProtocolStore
...
object MessageDecryptor {
   ...
   * These can vary from enqueueing jobs to inserting items into the [seraph.zion.signal.database.PendingRetryReceiptCache].
   */
  fun decrypt(
    context: Context,
