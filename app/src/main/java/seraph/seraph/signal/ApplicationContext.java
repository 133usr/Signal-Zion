...
<<<<<<< HEAD:app/src/main/java/seraph/seraph/signal/ApplicationContext.java
import seraph.zion.signal.avatar.AvatarPickerStorage;
import seraph.zion.signal.crypto.AttachmentSecretProvider;
import seraph.zion.signal.crypto.DatabaseSecretProvider;
import seraph.zion.signal.database.LogDatabase;
import seraph.zion.signal.database.SignalDatabase;
import seraph.zion.signal.database.SqlCipherLibraryLoader;
...
import seraph.zion.signal.emoji.JumboEmoji;
import seraph.zion.signal.gcm.FcmFetchManager;
import seraph.zion.signal.jobs.AccountConsistencyWorkerJob;
import seraph.zion.signal.jobs.CheckServiceReachabilityJob;
import seraph.zion.signal.jobs.DownloadLatestEmojiDataJob;
import seraph.zion.signal.jobs.EmojiSearchIndexDownloadJob;
import seraph.zion.signal.jobs.ExternalLaunchDonationJob;
import seraph.zion.signal.jobs.FcmRefreshJob;
import seraph.zion.signal.jobs.FontDownloaderJob;
import seraph.zion.signal.jobs.GroupRingCleanupJob;
import seraph.zion.signal.jobs.GroupV2UpdateSelfProfileKeyJob;
import seraph.zion.signal.jobs.MultiDeviceContactUpdateJob;
import seraph.zion.signal.jobs.PnpInitializeDevicesJob;
import seraph.zion.signal.jobs.PreKeysSyncJob;
import seraph.zion.signal.jobs.ProfileUploadJob;
import seraph.zion.signal.jobs.RefreshSvrCredentialsJob;
import seraph.zion.signal.jobs.RetrieveProfileJob;
import seraph.zion.signal.jobs.RetrieveRemoteAnnouncementsJob;
import seraph.zion.signal.jobs.StoryOnboardingDownloadJob;
import seraph.zion.signal.jobs.SubscriptionKeepAliveJob;
import seraph.zion.signal.keyvalue.KeepMessagesDuration;
...
import seraph.zion.signal.messageprocessingalarm.RoutineMessageFetchReceiver;
import seraph.zion.signal.migrations.ApplicationMigrations;
import seraph.zion.signal.mms.SignalGlideComponents;
import seraph.zion.signal.mms.SignalGlideModule;
...
import seraph.zion.signal.ringrtc.RingRtcLogger;
import seraph.zion.signal.service.DirectoryRefreshListener;
import seraph.zion.signal.service.KeyCachingService;
import seraph.zion.signal.service.LocalBackupListener;
import seraph.zion.signal.service.RotateSenderCertificateListener;
import seraph.zion.signal.service.RotateSignedPreKeyListener;
import seraph.zion.signal.apkupdate.ApkUpdateRefreshListener;
import seraph.zion.signal.service.webrtc.AndroidTelecomUtil;
...
import seraph.zion.signal.util.SignalUncaughtExceptionHandler;
import seraph.zion.signal.util.TextSecurePreferences;
import seraph.zion.signal.util.Util;
import seraph.zion.signal.util.VersionTracker;
...
>>>>>>> parent of 7d0641bdb6 (app now compiling):app/src/main/java/org/thoughtcrime/securesms/ApplicationContext.java
