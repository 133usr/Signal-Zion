...
import seraph.zion.signal.backup.v2.proto.GenericGroupUpdate;
import seraph.zion.signal.backup.v2.proto.GroupAdminStatusUpdate;
import seraph.zion.signal.backup.v2.proto.GroupAnnouncementOnlyChangeUpdate;
import seraph.zion.signal.backup.v2.proto.GroupAttributesAccessLevelChangeUpdate;
import seraph.zion.signal.backup.v2.proto.GroupAvatarUpdate;
import seraph.zion.signal.backup.v2.proto.GroupChangeChatUpdate;
import seraph.zion.signal.backup.v2.proto.GroupCreationUpdate;
import seraph.zion.signal.backup.v2.proto.GroupDescriptionUpdate;
import seraph.zion.signal.backup.v2.proto.GroupInvitationAcceptedUpdate;
import seraph.zion.signal.backup.v2.proto.GroupInvitationDeclinedUpdate;
import seraph.zion.signal.backup.v2.proto.GroupInvitationRevokedUpdate;
import seraph.zion.signal.backup.v2.proto.GroupInviteLinkAdminApprovalUpdate;
import seraph.zion.signal.backup.v2.proto.GroupInviteLinkDisabledUpdate;
import seraph.zion.signal.backup.v2.proto.GroupInviteLinkEnabledUpdate;
import seraph.zion.signal.backup.v2.proto.GroupInviteLinkResetUpdate;
import seraph.zion.signal.backup.v2.proto.GroupJoinRequestApprovalUpdate;
import seraph.zion.signal.backup.v2.proto.GroupJoinRequestCanceledUpdate;
import seraph.zion.signal.backup.v2.proto.GroupJoinRequestUpdate;
import seraph.zion.signal.backup.v2.proto.GroupMemberAddedUpdate;
import seraph.zion.signal.backup.v2.proto.GroupMemberJoinedUpdate;
import seraph.zion.signal.backup.v2.proto.GroupMemberLeftUpdate;
import seraph.zion.signal.backup.v2.proto.GroupMemberRemovedUpdate;
import seraph.zion.signal.backup.v2.proto.GroupMembershipAccessLevelChangeUpdate;
import seraph.zion.signal.backup.v2.proto.GroupNameUpdate;
import seraph.zion.signal.backup.v2.proto.GroupUnknownInviteeUpdate;
import seraph.zion.signal.backup.v2.proto.GroupV2AccessLevel;
import seraph.zion.signal.backup.v2.proto.GroupV2MigrationDroppedMembersUpdate;
import seraph.zion.signal.backup.v2.proto.GroupV2MigrationInvitedMembersUpdate;
import seraph.zion.signal.backup.v2.proto.GroupV2MigrationSelfInvitedUpdate;
import seraph.zion.signal.backup.v2.proto.GroupV2MigrationUpdate;
import seraph.zion.signal.backup.v2.proto.SelfInvitedOtherUserToGroupUpdate;
import seraph.zion.signal.backup.v2.proto.SelfInvitedToGroupUpdate;
import seraph.zion.signal.database.model.databaseprotos.GV2UpdateDescription;
import seraph.zion.signal.groups.GV2AccessLevelUtil;
...
import seraph.zion.signal.util.SpanUtil;
