...
package seraph.zion.signal.database.helpers.migration
...
import seraph.zion.signal.contacts.avatars.ContactColorsLegacy
import seraph.zion.signal.conversation.colors.AvatarColor
import seraph.zion.signal.conversation.colors.ChatColors
import seraph.zion.signal.conversation.colors.ChatColorsMapper
import seraph.zion.signal.database.KeyValueDatabase
import seraph.zion.signal.database.RecipientTable
import seraph.zion.signal.database.helpers.PreKeyMigrationHelper
import seraph.zion.signal.database.helpers.RecipientIdCleanupHelper
import seraph.zion.signal.database.helpers.RecipientIdMigrationHelper
import seraph.zion.signal.database.helpers.SessionStoreMigrationHelper
import seraph.zion.signal.database.helpers.SignalDatabaseMigrations
import seraph.zion.signal.database.model.databaseprotos.ReactionList
...
import seraph.zion.signal.util.FileUtils
import seraph.zion.signal.util.ServiceUtil
import seraph.zion.signal.util.Triple
