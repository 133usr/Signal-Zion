...
import seraph.zion.signal.components.RemovableEditableMediaView;
import seraph.zion.signal.components.ThumbnailView;
import seraph.zion.signal.components.location.SignalMapView;
...
import seraph.zion.signal.giph.ui.GiphyActivity;
import seraph.zion.signal.maps.PlacePickerActivity;
...
import seraph.zion.signal.payments.CanNotSendPaymentDialog;
import seraph.zion.signal.payments.PaymentsAddressException;
import seraph.zion.signal.payments.create.CreatePaymentFragmentArgs;
import seraph.zion.signal.payments.preferences.PaymentsActivity;
import seraph.zion.signal.payments.preferences.RecipientHasNotEnabledPaymentsDialog;
import seraph.zion.signal.payments.preferences.model.PayeeParcelable;
import seraph.zion.signal.permissions.PermissionCompat;
import seraph.zion.signal.permissions.Permissions;
import seraph.zion.signal.providers.BlobProvider;
import seraph.zion.signal.providers.DeprecatedPersistentBlobProvider;
...
import seraph.zion.signal.util.concurrent.AssertedSuccessListener;
import seraph.zion.signal.util.concurrent.ListenableFuture;
import seraph.zion.signal.util.concurrent.ListenableFuture.Listener;
import seraph.zion.signal.util.concurrent.SettableFuture;
