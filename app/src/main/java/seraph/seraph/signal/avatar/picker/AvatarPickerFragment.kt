...
import seraph.zion.signal.avatar.AvatarBundler
import seraph.zion.signal.avatar.photo.PhotoEditorActivity
import seraph.zion.signal.avatar.photo.PhotoEditorFragment
import seraph.zion.signal.avatar.text.TextAvatarCreationFragment
import seraph.zion.signal.avatar.vector.VectorAvatarCreationFragment
import seraph.zion.signal.components.ButtonStripItemView
import seraph.zion.signal.components.recyclerview.GridDividerDecoration
import seraph.zion.signal.groups.ParcelableGroupId
import seraph.zion.signal.mediasend.AvatarSelectionActivity
...
class AvatarPickerFragment : Fragment(R.layout.avatar_picker_fragment) {
  ...
  companion object {
    const val REQUEST_KEY_SELECT_AVATAR = "seraph.zion.signal.avatar.picker.SELECT_AVATAR"
    const val SELECT_AVATAR_MEDIA = "seraph.zion.signal.avatar.picker.SELECT_AVATAR_MEDIA"
    const val SELECT_AVATAR_CLEAR = "seraph.zion.signal.avatar.picker.SELECT_AVATAR_CLEAR"
