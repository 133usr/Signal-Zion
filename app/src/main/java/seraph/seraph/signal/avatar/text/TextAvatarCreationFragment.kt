...
import seraph.zion.signal.avatar.picker.AvatarPickerItem
import seraph.zion.signal.components.BoldSelectionTabItem
import seraph.zion.signal.components.ControllableTabLayout
...
class TextAvatarCreationFragment : Fragment(R.layout.text_avatar_creation_fragment) {
  ...
  companion object {
    const val REQUEST_KEY_TEXT = "seraph.zion.signal.avatar.text.TEXT"
  }
}
