...
package seraph.zion.signal.audio
...
import seraph.zion.signal.util.safeUnregisterReceiver
import seraph.zion.signal.webrtc.audio.SignalAudioHandler
 ...
 * reports that to the [seraph.zion.signal.webrtc.audio.SignalAudioManager], and then handles connecting/disconnecting
 * to the device if requested by [seraph.zion.signal.webrtc.audio.SignalAudioManager].
 */
