 ...
 *
 * @deprecated No longer have a PushDecryptJob to migrate, job now maps to {@link seraph.zion.signal.jobs.FailingJob}
 * in {@link seraph.zion.signal.jobs.JobManagerFactories}
 */
