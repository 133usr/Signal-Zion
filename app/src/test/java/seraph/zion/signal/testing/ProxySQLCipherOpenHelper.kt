...
class ProxySQLCipherOpenHelper(
  ...
  override val signalReadableDatabase: seraph.zion.signal.database.SQLiteDatabase
    get() = ProxySignalSQLiteDatabase(readableDatabase)

  override val signalWritableDatabase: seraph.zion.signal.database.SQLiteDatabase
