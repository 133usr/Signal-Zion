...
import static org.whispersystems.signalservice.internal.push.http.DigestingRequestBody.TAG;
...
//      Log.e(TAG, "from ServiceResponse result"+result.toString()+" status:"+String.valueOf(status)+" body:"+body);
